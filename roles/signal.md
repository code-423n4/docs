...
A. [Judges](/roles/judges.md) and [sponsors](/sponsors.md) can see the `signal` score of wardens and teams alongside their submissions. Your `signal` score is not visible to other wardens.
