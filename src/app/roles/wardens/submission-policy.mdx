...
Questions regarding this policy can be addressed in the `#questions` channel on the [C4 Discord](https://discord.gg/code4rena). We also invite you to contact us with suggestions for improving this policy.
